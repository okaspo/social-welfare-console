...
export default async function OfficerDetailPage({ params }: { params: { id: string } }) {
    ...
    if (!officer) {
        return (
            <div className="p-8 text-center">
                ...
                <Link href="/dashboard/officers" className="text-blue-600 underline">一覧に戻る</Link>
            </div>
        )
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                <Link href="/dashboard/officers" className="text-sm text-gray-500 hover:text-gray-900 flex items-center gap-1 mb-4">
